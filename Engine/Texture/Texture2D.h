...
namespace Engine {
	namespace Graphics {
		...
		private:
			Texture2D(const char* textureFileName, const unsigned int width, const unsigned int height, const unsigned int pixelFormat, const bool useGammaCorrection = false);
			Texture2D();
